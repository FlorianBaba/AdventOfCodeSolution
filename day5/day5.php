...
{
    $nbGoodWords = 0;
    foreach (explode(PHP_EOL, $string) as $word) {

        // Is it a good word ?
        if (isAGoodWord($word, $part)) {
            $nbGoodWords++;
        }
    }
 ...
 * @return bool
 */
function isAGoodWord($word, $part1)
{
    switch ($part1) {
        // part 1
        case 1:
            return isAGoodWordForPart1($word);
            break;

        // part 2
        case 2:
            return isAGoodWordForPart2($word);
            break;
 ...
 * @return bool
 */
function isAGoodWordForPart1($word)
{
...
function isAGoodWordForPart2($word)
{
...
echo '***** Solution - Day 5 *****'.PHP_EOL.PHP_EOL;
